  ...
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="row g-4 mt-5">
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
        <article class="kb-statement-card h-100" data-href="/academics/curriculum">
          <h3>Curriculum</h3>
      ...
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="180">
        <article class="kb-statement-card h-100" data-href="/student-life/extra-curricular">
      ...
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="260">
        <article class="kb-statement-card h-100" data-href="/resources/policies">
...
`,A={logoSrc:`/assets/images/others/school-logo.png`,shortName:`KinderBubble`,legalName:`Kinder Bubble International School`,tagline:`International School · Accra, Ghana`,addressLine1:`21 Quince Street, Community 18`,addressLine2:`Spintex Road, Accra, Ghana`,phoneDisplay:`+233 24 493 8605`,phoneTel:`+233244938605`,officeEmail:`info@kbubble.edu.gh`,hours:`6:00 a.m. - 6:00 p.m. · Open year-round`,principal:`Ms. Delphina Naa Lomoley Lomotey`,ages:`6 months - 10 years`,curriculum:`Cambridge International Curriculum with English-French bilingual exposure`,motto:`Ducem Scientia`,slogan:`Adikanfo - the pace setters`,mapQuery:`Kinder Bubble International School 21 Quince Street Community 18 Spintex Road Accra Ghana`,programs:[`Creche (6 mo - 2 yrs)`,`Nursery (2 - 3 yrs)`,`Kindergarten (3 - 4 yrs)`,`Reception (4 yrs)`,`Primary (5 - 10 yrs)`],highlights:[`Indoor and outdoor play spaces on campus`,`Rolling admissions throughout the year`,`Health, safety, and vetted staff as a priority`]},j={programmeBands:`bi-layers-fill`,languages:`bi-translate`,fullDay:`bi-clock-fill`,campusLocation:`bi-geo-alt-fill`,singleCampus:`bi-building-fill`,nurturingCare:`bi-balloon-heart-fill`,bilingual:`bi-translate`,movementPlay:`bi-tree-fill`,discovery:`bi-lightbulb-fill`,smallGroups:`bi-people-fill`,schoolReadiness:`bi-mortarboard-fill`,routines:`bi-shield-check`,globalOutlook:`bi-globe-europe-africa`,foundations:`bi-journal-text`,programsByAge:`bi-layers-fill`,indoorOutdoorPlay:`bi-tree-fill`,safety:`bi-shield-check`,accredited:`bi-patch-check-fill`,admissionsRolling:`bi-calendar-event`,planVisit:`bi-calendar-check`,applicationForm:`bi-file-earmark-text-fill`,medicalForm:`bi-file-medical-fill`,pickUpAuth:`bi-person-badge-fill`,brochure:`bi-journal-richtext`,healthPolicy:`bi-heart-pulse-fill`,privacy:`bi-shield-check`,terms:`bi-file-text`,musicCreativity:`bi-music-note-beamed`,languageCulture:`bi-translate`,inquiryDiscovery:`bi-lightbulb-fill`,learningStudios:`bi-book-fill`,playMovement:`bi-tree-fill`,wellbeingCommunity:`bi-people-fill`,familyPartnership:`bi-chat-heart-fill`};function $n(e){let t=[{title:e.programs[0],blurb:`Warm routines, sensory-rich play, and caring adults who partner closely with families from the very first day.`,meta0:`Early years`,meta1:`6 mo – 2 yrs`,img:`/assets/images/students/smiling-girl-orange-uniform-kbis-02.jpeg`,alt:`Creche and youngest learners at KBIS`},{title:e.programs[1],blurb:`Curiosity-led learning, early literacy and numeracy, and plenty of movement — indoors and out.`,meta0:`Nursery`,meta1:`2 – 3 yrs`,img:`/assets/images/students/formal-uniform-students-kbis-01.jpeg`,alt:`Nursery learners at KBIS`},{title:e.programs[2],blurb:`Structured play, social skills, and gentle preparation for the rhythms of primary.`,meta0:`Kindergarten`,meta1:`3 – 4 yrs`,img:`/assets/images/students/girl-in-orange-uniform-kbis-03.jpeg`,alt:`Kindergarten at KBIS`},{title:e.programs[3],blurb:`A bridge year focused on confidence, independence, and foundational skills across subjects.`,meta0:`Reception`,meta1:`4 yrs`,img:`/assets/images/students/smiling-child-on-turf-kbis-04.jpeg`,alt:`Reception learners at KBIS`},{title:e.programs[4],blurb:`Project-based learning, literacy depth, and numeracy fluency with strong pastoral support through the primary years.`,meta0:`Primary`,meta1:`5 – 10 yrs`,img:`/assets/images/facilities/blue-stairwell-kbis-10.jpeg`,alt:`Primary learners at KBIS`}].map((e,t)=>`
              ...
              <div class="banner-info">
                <div class="program-header">
                  ...
                  <div class="program-stats">
                    <span><i class="bi ${j.fullDay}"></i> ${e.hours.split(`·`)[0].trim()}</span>
                    <span><i class="bi ${j.languages}"></i> English &amp; French exposure</span>
                  </div>
                </div>
        ...
        <div class="row g-4 mt-4">
          <div class="col-xl-3 col-lg-6 col-md-6">
            <div class="metric-card" data-href="/academics/programmes" data-aos="flip-left" data-aos-delay="300">
              <div class="metric-header">
                <div class="metric-icon-wrapper"><i class="bi ${j.programmeBands}"></i></div>
          ...
          <div class="col-xl-3 col-lg-6 col-md-6">
            <div class="metric-card" data-href="/academics/languages" data-aos="flip-left" data-aos-delay="400">
              <div class="metric-header">
                <div class="metric-icon-wrapper"><i class="bi ${j.languages}"></i></div>
          ...
          <div class="col-xl-3 col-lg-6 col-md-6">
            <div class="metric-card" data-href="/parents/plan-a-visit" data-aos="flip-left" data-aos-delay="500">
              <div class="metric-header">
                <div class="metric-icon-wrapper"><i class="bi ${j.fullDay}"></i></div>
          ...
          <div class="col-xl-3 col-lg-6 col-md-6">
            <div class="metric-card" data-href="/campus-facilities" data-aos="flip-left" data-aos-delay="600">
              <div class="metric-header">
                <div class="metric-icon-wrapper"><i class="bi ${j.campusLocation}"></i></div>
  ...
  `}function er(){return $n(A)}function tr(){let e=A.programs.map(e=>`<option>${e}</option>`).join(``);return`
    <div class="page-title light-background">
      <div class="container d-lg-flex justify-content-between align-items-center">
              ...
              <div class="steps-wrapper">
                <div class="step-item">
                  ...
                  <div class="step-content">
                    <h4>Enquire</h4>
                    <p>Call <a href="tel:${A.phoneTel}">${A.phoneDisplay}</a> or email <a href="mailto:${A.officeEmail}">${A.officeEmail}</a> with your child’s age and preferred start window.</p>
                  </div>
                </div>
                <div class="step-item">
            ...
            <div class="deadlines-card">
              ...
              <div class="deadlines-grid">
                <div class="deadline-item" data-aos="zoom-in" data-aos-delay="200">
                  ...
                  <p>${A.highlights[1]} Natural entry points across creche, nursery, kindergarten, reception, and primary.</p>
                </div>
                ...
                <div class="deadline-item" data-aos="zoom-in" data-aos-delay="400">
                  ...
                  <h4>Campus tours</h4>
                  <p>Book a visit that fits your schedule — ${A.hours.toLowerCase()}</p>
                </div>
        ...
        <div class="row mt-5 campus-visit">
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="200">
            <div class="visit-content">
              ...
              <p>${A.legalName} welcomes families who want to feel the rhythm of the day — bilingual exposure, Cambridge-inspired planning, and ${A.highlights[0].toLowerCase()} Meet admissions, peek into learning studios, and ask candid questions.</p>
              ...
              <div class="virtual-option">
                ...
                <a href="tel:${A.phoneTel}" class="virtual-link">Call the office <i class="bi bi-arrow-right"></i></a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="row g-0 align-items-center">
            <div class="col-lg-8" data-aos="fade-right" data-aos-delay="200">
              <div class="content-wrapper">
                ...
                <p class="lead-text">${A.addressLine1}, ${A.addressLine2}. Our campus pairs bright classrooms with safe outdoor play — all designed around how children ${A.ages} actually learn and move.</p>
                <div class="feature-highlights">
                  <div class="highlight-item">
                    <i class="bi ${j.programmeBands}"></i>
                    <div>
        ...
        <div class="facilities-grid" data-aos="fade-up" data-aos-delay="200">
          <div class="category-card academic" data-aos="zoom-in" data-aos-delay="100">
            <div class="card-header">
              <div class="icon-wrapper"><i class="bi ${j.learningStudios}"></i></div>
          ...
          <div class="category-card sports" data-aos="zoom-in" data-aos-delay="200">
            <div class="card-header">
              <div class="icon-wrapper"><i class="bi ${j.playMovement}"></i></div>
              <h3>Play &amp; movement</h3>
            </div>
            <div class="card-content">
              <div class="facility-image">
              ...
              <div class="facility-list">
                <div class="facility-item"><i class="bi bi-check2-circle"></i><span>${A.highlights[0]}</span></div>
          ...
          <div class="category-card residence" data-aos="zoom-in" data-aos-delay="300">
            <div class="card-header">
              <div class="icon-wrapper"><i class="bi ${j.wellbeingCommunity}"></i></div>
            ...
            <div class="card-content">
              ...
              <div class="facility-list">
                <div class="facility-item"><i class="bi bi-check2-circle"></i><span>${A.highlights[2]}</span></div>
  ...
  `}function rr(){let e=`https://www.google.com/maps?q=${encodeURIComponent(A.mapQuery)}&z=17&output=embed`,t=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(A.mapQuery)}`;return`
    <div class="page-title light-background">
      <div class="container d-lg-flex justify-content-between align-items-center">
    ...
    <section id="contact" class="contact section">
      <div class="container">
        <div class="kb-contact-hero row g-4 align-items-stretch mb-4">
          <div class="col-12">
            <div class="kb-contact-intro h-100">
              ...
              <p>Use the map pointer for ${A.addressLine1}, ${A.addressLine2}. For tours, admissions, forms, or feedback, contact the office and we will route your message correctly.</p>
              <div class="kb-contact-actions">
                <a href="tel:${A.phoneTel}" class="btn btn-primary">${A.phoneDisplay}</a>
                <a href="mailto:${A.officeEmail}" class="btn btn-outline-primary">${A.officeEmail}</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="contact-cards-container mb-4">
          ...
          <div class="contact-card" data-href="mailto:${A.officeEmail}"><div class="icon-box"><i class="bi bi-envelope"></i></div><div class="contact-text"><h4>Email</h4><p><a href="mailto:${A.officeEmail}">${A.officeEmail}</a></p></div></div>
          <div class="contact-card" data-href="tel:${A.phoneTel}"><div class="icon-box"><i class="bi bi-telephone"></i></div><div class="contact-text"><h4>Phone</h4><p><a href="tel:${A.phoneTel}">${A.phoneDisplay}</a></p></div></div>
          <div class="contact-card"><div class="icon-box"><i class="bi bi-clock"></i></div><div class="contact-text"><h4>Hours</h4><p>${A.hours.split(` · `)[0]}</p></div></div>
        </div>
            ...
            <div class="kb-contact-form-inner">
              ...
              <form action="#" method="post" class="php-email-form" data-form-type="contact-feedback">
                ...
                <div class="kb-form-footer">
                  <p class="small text-muted mb-0">Or email <a href="mailto:${A.officeEmail}">${A.officeEmail}</a> · <a href="tel:${A.phoneTel}">${A.phoneDisplay}</a></p>
        ...
        <div class="row g-4">
          <div class="col-lg-8">
            <div class="events-list kb-event-list">
              ${[[`Anniversary celebration`,`Annual`,`A grand school programme celebrating KBIS growth, culture, performances, family participation, and the school community.`,`/assets/images/extra-curricular/students-on-stage-at-event.jpeg`],[`Graduation and moving-up ceremony`,`End term`,`A milestone celebration where learners were recognised for growth, confidence, and readiness for the next stage.`,`/assets/images/extra-curricular/career-day-costume-group-certificates.jpeg`],[`Educational trips`,`Trips`,`Theme-based outings connected classroom learning to real places, with learners exploring, asking questions, and returning with stories to share.`,`/assets/images/extra-curricular/school-excursion-group-photo.jpeg`],[`Career and culture day`,`School life`,`Children dressed, presented, and explored real-world roles through guided play, family support, and joyful classroom activities.`,`/assets/images/extra-curricular/career-day-children-in-costumes.jpeg`],[`Independence and national moments`,`Culture`,`Learners celebrated Ghanaian identity through flags, presentations, group moments, and guided conversations about citizenship.`,`/assets/images/extra-curricular/students-with-ghana-flags-under-tent.jpeg`]].map(([e,t,n,r],i)=>`
                <article class="event-item" data-aos="fade-up" data-aos-delay="${i*80}" data-href="/event-details">
                  <div class="kb-event-thumb"><img src="${r}" alt="" loading="lazy"></div>
                  <div class="event-date"><span class="day">${t.split(` `)[0]}</span><span class="month">${t.split(` `).slice(1).join(` `)||`KBIS`}</span></div>
    ...
    <section id="news-hero" class="news-hero section kb-news-page">
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="kb-news-grid">
          ${[[`12`,`Jun`,`Partnership with Global School Alliance`,`School news`,`Events`,`KBIS has benefited from GSA support and a sister-school partnership with Skidby Church of England Primary School in Yorkshire, England.`,`/assets/images/extra-curricular/students-group-at-independence-square.jpeg`,`/news/partnerships`,`214`],[`06`,`May`,`Bilingual curriculum focus`,`Academics`,`Learning`,`KBIS follows the Cambridge International Curriculum with English-French bilingual exposure and age-right classroom routines.`,`/assets/images/learning/children-reading-together.jpeg`,`/academics/languages`,`186`],[`29`,`Apr`,`Health, allergy, and pick-up forms`,`Parents`,`Notices`,`Families can access application, medical, and authorised pick-up forms from the parents and policies pages.`,`/assets/images/learning/children-holding-green-apple.jpeg`,`/parents/admission-form`,`152`],[`18`,`Mar`,`Educational trips by term theme`,`Events`,`Campus`,`Trips are planned around term themes and lesson plans, with parent communication and safety planning before departure.`,`/assets/images/extra-curricular/school-excursion-students-walking.jpeg`,`/events`,`128`],[`14`,`Feb`,`Classroom routines that help children settle`,`School news`,`Wellbeing`,`Daily routines help children feel confident, understand expectations, and move calmly between learning, meals, rest, and play.`,`/assets/images/students/children-seated-in-class.jpeg`,`/parents/student-handbook`,`119`],[`24`,`Jan`,`Learning through play and discovery`,`Academics`,`Programmes`,`From early years to primary, children learn through guided practice, creative projects, outdoor movement, and classroom conversation.`,`/assets/images/learning/children-handling-class-activity.jpeg`,`/academics/programmes`,`143`]].map(([e,t,n,r,i,a,o,s,c],l)=>`
            <div data-aos="fade-up" data-aos-delay="${100+l*70}">
              <article class="kb-news-card" data-href="${s}">
                <a class="kb-news-card-image" href="${s}" aria-label="${n}">
                ...
                <div class="kb-news-card-body">
                  <div class="kb-news-meta">
                    ...
                    <em><i class="bi bi-eye"></i>${c}</em>
                  </div>
                  <h2><a href="${s}">${n}</a></h2>
                  <p>${a}</p>
                  <a class="kb-news-read-more" href="${s}">Read more</a>
                </div>
              </article>
            </div>`).join(``)}
        </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
              <div class="faculty-card">
                <div class="faculty-image">
                  <img src="/assets/images/learning/outdoor-presentation-kbis-08.jpeg" class="img-fluid" alt="${A.principal}" loading="lazy">
                  <div class="social-links">
                    <a href="mailto:${A.officeEmail}" aria-label="Email"><i class="bi bi-envelope"></i></a>
                  </div>
                </div>
                <div class="faculty-info">
                  <h3>${A.principal}</h3>
                  <p class="position">Principal</p>
                  <div class="department">${A.legalName}</div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
              <div class="faculty-card">
                ...
                <div class="faculty-info">
                  ...
                  <div class="department">${A.curriculum}</div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
              <div class="faculty-card">
                ...
                <div class="faculty-info">
                  ...
                  <div class="department">${A.hours}</div>
                  <div class="research-tags"><span>${A.highlights[2]}</span><span>Routines</span><span>Reception</span></div>
  ...
  `}var sr=JSON.stringify({loop:!0,speed:600,autoplay:{delay:5e3},slidesPerView:1,spaceBetween:30,pagination:{el:`.swiper-pagination`,type:`bullets`,clickable:!0},breakpoints:{768:{slidesPerView:2},992:{slidesPerView:3}}});function cr(){return`
    <div class="page-title light-background">
      <div class="container d-lg-flex justify-content-between align-items-center">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row">
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="student-life-intro">
              ...
              <p>${A.curriculum}. ${A.highlights[0]}</p>
              <div class="mt-4">
        ...
        <div class="student-organizations mt-5 pt-4" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="row g-4">
            ...
            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="300">
              <div class="organization-card">
                <div class="icon-box"><i class="bi ${j.languageCulture}"></i></div>
            ...
            <div class="col-md-4" data-aos="zoom-in" data-aos-delay="400">
              <div class="organization-card">
                <div class="icon-box"><i class="bi ${j.inquiryDiscovery}"></i></div>
        ...
        <div class="athletics-programs mt-5 pt-3" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="athletics-slider swiper init-swiper" data-aos="fade-up" data-aos-delay="300">
            <script type="application/json" class="swiper-config">${sr}<\/script>
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="athletics-card">
                  ...
                  <div class="athletics-content"><h5>Outdoor play</h5><p>${A.highlights[0]}</p></div>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="athletics-card">
          ...
          <div class="article-header">
            ...
            <div class="article-meta" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="post-info">
                ...
                <span><i class="bi bi-clock"></i> ${A.hours}</span>
                <span><i class="bi bi-geo-alt"></i> ${A.addressLine2}</span>
              </div>
            </div>
          </div>
          ...
          <div class="article-wrapper">
            ...
            <div class="article-content">
              <div class="content-section" id="intro" data-aos="fade-up">
                <p class="lead">${A.highlights[1]} Families often begin with a phone call or email, then schedule a walk-through that fits the school week.</p>
                <p>${A.legalName} serves children ${A.ages} with ${A.curriculum.toLowerCase()}. ${A.highlights[0]}</p>
              </div>
              ...
              <div class="content-section" id="next" data-aos="fade-up">
                <h2>Next steps</h2>
                <p>When you are ready, we share the application pack and timeline. <a href="/contact">Contact the office</a> or call <a href="tel:${A.phoneTel}">${A.phoneDisplay}</a>.</p>
              </div>
            </div>
          </div>
        </article>
          ...
          <div class="col-lg-8">
            ...
            <div class="event-meta mb-4" data-aos="fade-up" data-aos-delay="100">
              <div class="row g-3">
                ...
                <div class="col-md-4"><div class="meta-item"><i class="bi bi-geo-alt"></i><span>${A.addressLine2}</span></div></div>
              </div>
            </div>
                ...
                <div class="organizer-details">
                  ...
                  <div class="organizer-content">
                    ...
                    <div class="organizer-contact">
                      <p><i class="bi bi-envelope"></i> <a href="mailto:${A.officeEmail}">${A.officeEmail}</a></p>
                      <p><i class="bi bi-telephone"></i> <a href="tel:${A.phoneTel}">${A.phoneDisplay}</a></p>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <section class="section kb-policy-page">
      <div class="container" data-aos="fade-up">
        ...
        <div class="kb-policy-alert mt-4" data-aos="fade-up">
          <i class="bi bi-info-circle"></i>
          <p class="mb-0">For any policy question or special circumstance, contact the office at <a href="tel:${A.phoneTel}">${A.phoneDisplay}</a> or <a href="mailto:${A.officeEmail}">${A.officeEmail}</a>.</p>
        </div>
        ...
        <div class="row g-4 mt-4 kb-policy-sections">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="260">
            <article class="kb-policy-card h-100">
              <div class="kb-policy-icon"><i class="bi ${j.healthPolicy}"></i></div>
          ...
          <div class="row g-3">
            <div class="col-md-6 col-xl-4">
              <a href="/assets/docs/KBIS-Application-form.docx" class="kb-resource-card d-flex gap-3 text-decoration-none">
                <span class="kb-resource-icon"><i class="bi ${j.applicationForm}"></i></span>
            ...
            <div class="col-md-6 col-xl-4">
              <a href="/assets/docs/Kinder-Bubble-Medical.docx" class="kb-resource-card d-flex gap-3 text-decoration-none">
                <span class="kb-resource-icon"><i class="bi ${j.medicalForm}"></i></span>
            ...
            <div class="col-md-6 col-xl-4">
              <a href="/assets/docs/After-School-Pick-up-Authorisation-Forms.docx" class="kb-resource-card d-flex gap-3 text-decoration-none">
                <span class="kb-resource-icon"><i class="bi ${j.pickUpAuth}"></i></span>
            ...
            <div class="col-md-6 col-xl-4">
              <a href="/assets/docs/mini-brochure.pdf" class="kb-resource-card d-flex gap-3 text-decoration-none" target="_blank" rel="noopener noreferrer">
                <span class="kb-resource-icon"><i class="bi ${j.brochure}"></i></span>
            ...
            <div class="col-md-6 col-xl-4">
              <a href="/privacy" class="kb-resource-card d-flex gap-3 text-decoration-none">
                <span class="kb-resource-icon"><i class="bi ${j.privacy}"></i></span>
            ...
            <div class="col-md-6 col-xl-4">
              <a href="/terms-of-service" class="kb-resource-card d-flex gap-3 text-decoration-none">
                <span class="kb-resource-icon"><i class="bi ${j.terms}"></i></span>
  ...
  <div class="row g-3">
    ${pr.map(e=>`
        <div class="col-md-6">
          <a class="kb-resource-card d-flex gap-3 text-decoration-none" href="${e.href}"${fr(e.href)}>
  ...
  </div>`,Cr=({title:e,parent:t,parentHref:n,heroImage:r,kicker:i,heading:a,lead:o,body:s,heroClass:c=``})=>`
  ${br(e,t,n)}
  <section class="section kb-designed-page">
    <div class="container" data-aos="fade-up">
      ...
      ${s}
  ...
  </section>`,wr={"about-mission-vision":()=>({title:`Mission & vision - Kinder Bubble International School`,bodyClass:`about-mission-vision-page`,mainHtml:Cr({title:`Mission & vision`,parent:`About`,parentHref:`/about`,heroImage:M.mission,kicker:A.motto,heading:`A caring school shaped by character, academics, and confidence.`,lead:`KBIS exists to prepare future innovators through a balanced blend of character formation, academic habits, bilingual learning, and joyful early childhood care.`,body:`
        ...
        ${Sr([{kicker:`Culture`,title:A.slogan,text:`A school identity rooted in heritage, leadership, and high expectations for young learners.`,image:`/assets/images/students/students-in-blue-uniforms-outdoor.jpg`,href:`/about`},{kicker:`Learning`,title:`Character plus academics`,text:`Daily routines connect kindness, independence, creativity, numeracy, literacy, and bilingual expression.`,image:`/assets/images/learning/children-handling-class-activity.jpeg`,href:`/academics/curriculum`},{kicker:`Family`,title:`One child at a time`,text:`Parents, teachers, and leaders work as a close circle around each child.`,image:`/assets/images/extra-curricular/parents-and-children-at-event.jpeg`,href:`/parents/plan-a-visit`}])}`})}),"about-board-of-directors":()=>({title:`Board of directors - Kinder Bubble International School`,bodyClass:`about-board-page`,mainHtml:Cr({title:`Board of directors`,parent:`About`,parentHref:`/about`,heroImage:M.board,kicker:`Governance`,heading:`Experienced leaders supporting the school mission.`,lead:`The board provides oversight, enterprise experience, and community leadership so KBIS can grow with discipline and care.`,heroClass:`kb-board-hero`,body:`
        ...
        </div>`})}),"about-management":()=>({title:`Management - Kinder Bubble International School`,bodyClass:`about-management-page`,mainHtml:Cr({title:`Management`,parent:`About`,parentHref:`/about`,heroImage:M.director,kicker:`Leadership`,heading:`Management that keeps learning, safety, and communication moving.`,lead:`The school director, principal, administration, and classroom leads coordinate the everyday work families feel: safe arrival, strong routines, and steady feedback.`,body:Sr([{kicker:`Director`,title:`Raphael Asamoah Boadu`,text:`Since 2021, leadership has focused on a thriving learning environment, engaged community, and forward-looking teaching methods.`,image:`/assets/images/students/two-students-in-formal-uniforms.jpeg`,href:`/about/board-of-directors`},{kicker:`Principal`,title:A.principal,text:`A child-centred educator supporting classroom practice, parent partnership, and learner confidence.`,image:`/assets/images/others/staff-member-at-desk.jpg`,href:`/about/principal`},{kicker:`Office`,title:`Admissions and administration`,text:`The office helps families with visits, forms, fees, medical information, and authorised pick-up records.`,image:`/assets/images/others/ms-yvonne-asamoah-boadu.jpeg`,href:`/contact`}])})}),"about-principal":()=>({title:`Principal - Kinder Bubble International School`,bodyClass:`about-principal-page`,mainHtml:`
      ${br(`Principal`,`About`,`/about`)}
      <section class="section kb-principal-profile">
        <div class="container" data-aos="fade-up">
          <div class="kb-principal-profile-shell">
            <div class="kb-principal-photo-wrap">
              <img src="${M.principal}" alt="${A.principal}" loading="lazy">
              <span><i class="bi bi-circle-fill"></i>${A.principal}</span>
            </div>
          ...
          <article class="kb-principal-detail-card" data-aos="fade-up" data-aos-delay="120">
            ...
            <p>s Principal of Kinder Bubble International School, <strong>${A.principal}</strong> brings a gentle, steady presence to the daily life of the school. She helps children feel known, safe, and confident while guiding teachers to make learning active, caring, and purposeful. Families value her warm communication, her attention to each child&apos;s progress, and her commitment to a school culture where kindness, discipline, creativity, and strong foundations grow together.</p>
            <span class="kb-principal-detail-icon"><i class="bi bi-mortarboard-fill"></i></span>
          </article>
        </div>
      </section>`}),"about-staff-teaching":()=>({title:`Teaching staff - Kinder Bubble International School`,bodyClass:`about-staff-teaching-page`,mainHtml:Cr({title:`Teaching staff`,parent:`About`,parentHref:`/about`,heroImage:M.teaching,kicker:`Teachers`,heading:`Professional teachers who love teaching children daily.`,lead:`Our classroom team supports bilingual learning, early literacy, numeracy, inquiry, creativity, and calm transitions through the day.`,body:`
        <div class="kb-teacher-grid mt-4">
          ${hr.map(([e,t,n],r)=>`
              <article class="kb-teacher-card" data-aos="fade-up" data-aos-delay="${80+r*35}">
        ...
        ${Sr([{kicker:`Classroom`,title:`Small group teaching`,text:`Whole class, ability groups, mixed ability groups, and paired work are used during the week.`,image:`/assets/images/learning/teacher-with-small-class.jpeg`,href:`/academics/curriculum`},{kicker:`Languages`,title:`English and French`,text:`Daily lessons and language exposure are tailored to each child according to age and ability.`,image:`/assets/images/learning/children-reading-together.jpeg`,href:`/academics/languages`},{kicker:`Family`,title:`Continuity of care`,text:`Permanent educators help children know the adults around them and feel settled.`,image:`/assets/images/students/children-at-classroom-table.jpg`,href:`/contact`}])}`})}),"about-staff-support":()=>({title:`Support staff - Kinder Bubble International School`,bodyClass:`about-staff-support-page`,mainHtml:Cr({title:`Support staff`,parent:`About`,parentHref:`/about`,heroImage:M.support,kicker:`Care and operations`,heading:`The practical team behind safe, smooth school days.`,lead:`Support staff help with reception, health routines, meals, cleaning, authorised pick-up, and family communication.`,body:Sr([{kicker:`Health`,title:`Medical awareness`,text:`Allergies, dietary restrictions, and emergency plans are documented and shared with relevant staff.`,image:`/assets/images/learning/children-holding-green-apple.jpeg`,href:`/parents/admission-form`},{kicker:`Pick-up`,title:`Authorised collection`,text:`Families can complete pick-up authorisation so the school knows exactly who may collect a child.`,image:`/assets/images/extra-curricular/students-lined-up-outdoors.jpeg`,href:`/parents/student-handbook`},{kicker:`Meals`,title:`Feeding routines`,text:`Breakfast, lunch, snacks, and family restrictions are handled with careful hygiene routines.`,image:`/assets/images/extra-curricular/staff-serving-food-at-event.jpeg`,href:`/resources/policies`}])})}),"academics-curriculum":()=>({title:`Curriculum - Kinder Bubble International School`,bodyClass:`academics-curriculum-page`,mainHtml:Cr({title:`Curriculum`,parent:`Academics`,parentHref:`/academics`,heroImage:M.curriculum,kicker:`Cambridge + bilingual`,heading:`Structured learning with equal respect for language, character, and creativity.`,lead:`KBIS follows the Cambridge International Curriculum and bilingual English-French studies, with teaching planned for children from early years through primary.`,body:`
        ...
        ${Sr([{kicker:`Balance`,title:`English-French rhythm`,text:`The brochure describes a balanced bilingual model with Anglophone and Francophone teaching support.`,image:`/assets/images/learning/teacher-guided-table-activity.jpeg`,href:`/academics/curriculum`},{kicker:`Culture`,title:`Global readiness`,text:`French opens doors to wider international communication and cultural understanding.`,image:`/assets/images/extra-curricular/students-with-ghana-flags-at-monument.jpeg`,href:`/news/partnerships`},{kicker:`Everyday`,title:`Songs, stories, routines`,text:`Language exposure is built into activities children already enjoy.`,image:`/assets/images/learning/girl-presenting-in-class.jpeg`,href:`/students-life`}])}`})}),"academics-academic-calendar":()=>({title:`Academic calendar - Kinder Bubble International School`,bodyClass:`academics-calendar-page`,mainHtml:Cr({title:`Academic calendar`,parent:`Academics`,parentHref:`/academics`,heroImage:M.calendar,kicker:`Planning`,heading:`Term rhythm, public holidays, school events, and family updates.`,lead:`The school calendar includes term work, public holidays, educational trips, parent meetings, celebrations of learning, and open campus moments.`,body:`
        ...
        ${Sr([{kicker:`Admissions`,title:`Rolling entry`,text:`Families can ask about available places throughout the year.`,image:`/assets/images/students/smiling-boy-in-class-hero.jpeg`,href:`/admissions`},{kicker:`Trips`,title:`Educational visits`,text:`Trips are organised around themes and lesson plans for each academic term.`,image:`/assets/images/extra-curricular/school-excursion-students-walking.jpeg`,href:`/events`},{kicker:`Student life`,title:`Beyond the classroom`,text:`Houses, SRC, extra-curricular clubs, and celebrations shape a full school experience.`,image:`/assets/images/extra-curricular/children-with-balloons-on-turf.jpeg`,href:`/students-life`}])}`})}),"student-life-src":()=>({title:`SRC - Kinder Bubble International School`,bodyClass:`student-life-src-page`,mainHtml:Cr({title:`SRC`,parent:`Student life`,parentHref:`/students-life`,heroImage:M.src,kicker:`Student voice`,heading:`Age-appropriate leadership, responsibility, and confidence.`,lead:`For young learners, leadership starts with small habits: helping, listening, speaking kindly, and taking turns.`,body:`
        ...
        ${Sr([{kicker:`Voice`,title:`Classroom feedback`,text:`Children learn to share ideas, ask questions, and listen to classmates.`,image:`/assets/images/learning/girl-presenting-in-class-gallery.jpeg`,href:`/students-life`},{kicker:`Service`,title:`Helping routines`,text:`Class jobs and shared responsibilities build ownership.`,image:`/assets/images/students/children-sitting-on-floor.jpeg`,href:`/student-life/houses`},{kicker:`Confidence`,title:`Presentation moments`,text:`Show-and-tell and class sharing help children practise speaking.`,image:`/assets/images/learning/child-presenting-poster.jpeg`,href:`/events`}])}`})}),"student-life-houses":()=>({title:`Houses - Kinder Bubble International School`,bodyClass:`student-life-houses-page`,mainHtml:Cr({title:`Houses`,parent:`Student life`,parentHref:`/students-life`,heroImage:M.houses,kicker:`Belonging`,heading:`Friendly house spirit that builds teamwork and pride.`,lead:`House activities give children a sense of identity, encouragement, and shared celebration without overwhelming them.`,body:`
      ...
      <section class="section kb-album-gallery">
      ...
      </section>`}),"resources-policies":()=>({title:`Policies - Kinder Bubble International School`,bodyClass:`resources-policies-page`,mainHtml:dr()}),"news-partnerships":()=>({title:`Partnerships - Kinder Bubble International School`,bodyClass:`news-partnerships-page`,mainHtml:Cr({title:`Partnerships`,parent:`News`,parentHref:`/news`,heroImage:M.partnership,kicker:`Global School Alliance`,heading:`International connections that widen children's view of the world.`,lead:`Through the Global School Alliance, KBIS has established a sister-school partnership with Skidby Church of England Primary School in Yorkshire, England.`,body:`
        ...
        ${Sr([{kicker:`Global`,title:`Global School Alliance`,text:`A network helping educators connect, collaborate on projects, and develop transformational international partnerships.`,image:`/assets/images/others/global-school-alliance-certificate.png`,href:`/news/partnerships`},{kicker:`Sister school`,title:`Skidby Church of England Primary School`,text:`The partnership creates opportunities for cultural exchange, student interaction, and teacher collaboration.`,image:`/assets/images/extra-curricular/students-with-ghana-flags-at-monument.jpeg`,href:`/news`},{kicker:`Next`,title:`Upcoming partnership updates`,text:`Families will receive details as exchange activities and collaborative projects are scheduled.`,image:`/assets/images/extra-curricular/students-group-at-independence-square.jpeg`,href:`/events`}])}`})})},Tr=[{path:`/about/mission-vision`,key:`about-mission-vision`,label:`Mission & vision`},{path:`/about/board-of-directors`,key:`about-board-of-directors`,label:`Board of directors`},{path:`/about/management`,key:`about-management`,label:`Management`},{path:`/about/principal`,key:`about-principal`,label:`Principal`},{path:`/about/staff/teaching`,key:`about-staff-teaching`,label:`Teaching staff`},{path:`/about/staff/support`,key:`about-staff-support`,label:`Support staff`},{path:`/academics/curriculum`,key:`academics-curriculum`,label:`Curriculum`},{path:`/academics/programmes`,key:`academics-programmes`,label:`Programmes`},{path:`/academics/languages`,key:`academics-languages`,label:`Languages`},{path:`/academics/academic-calendar`,key:`academics-academic-calendar`,label:`Academic calendar`},{path:`/student-life/src`,key:`student-life-src`,label:`SRC`},{path:`/student-life/houses`,key:`student-life-houses`,label:`Houses`},{path:`/student-life/extra-curricular`,key:`student-life-extra-curricular`,label:`Extra curricula`},{path:`/parents/admission-form`,key:`parents-admission-form`,label:`Admission form`},{path:`/parents/plan-a-visit`,key:`parents-plan-a-visit`,label:`Plan a visit`},{path:`/parents/make-payment`,key:`parents-make-payment`,label:`Make payment`},{path:`/parents/student-handbook`,key:`parents-student-handbook`,label:`Student handbook`},{path:`/resources/gallery`,key:`resources-gallery`,label:`Gallery`},{path:`/resources/policies`,key:`resources-policies`,label:`Policies`},{path:`/news/partnerships`,key:`news-partnerships`,label:`Partnerships`}],Er=Tr.map(({key:e})=>({name:e,...wr[e]()})),Dr=[{name:`index`,title:`Kinder Bubble International School · Accra`,bodyClass:`index-page`,mainHtml:er()},{name:`about`,title:`About · Kinder Bubble International School`,bodyClass:`about-page`,mainHtml:Jn},{name:`academics`,title:`Academics · Kinder Bubble International School`,bodyClass:`academics-page`,mainHtml:Yn},{name:`admissions`,title:`Admissions · Kinder Bubble International School`,bodyClass:`admissions-page`,mainHtml:tr()},{name:`campus-facilities`,title:`Campus & facilities · Kinder Bubble International School`,bodyClass:`campus-facilities-page`,mainHtml:nr()},{name:`contact`,title:`Contact · Kinder Bubble International School`,bodyClass:`contact-page`,mainHtml:rr()},{name:`event-details`,title:`Event details · Kinder Bubble International School`,bodyClass:`event-details-page`,mainHtml:ur()},{name:`events`,title:`Events · Kinder Bubble International School`,bodyClass:`events-page`,mainHtml:ir()},{name:`faculty-staff`,title:`Our team · Kinder Bubble International School`,bodyClass:`faculty-staff-page`,mainHtml:or()},{name:`news-details`,title:`News details · Kinder Bubble International School`,bodyClass:`news-details-page`,mainHtml:lr()},{name:`news`,title:`News · Kinder Bubble International School`,bodyClass:`news-page`,mainHtml:ar()},{name:`privacy`,title:`Privacy · Kinder Bubble International School`,bodyClass:`privacy-page`,mainHtml:Xn},{name:`students-life`,title:`Student life · Kinder Bubble International School`,bodyClass:`students-life-page`,mainHtml:cr()},{name:`terms-of-service`,title:`Terms of service · Kinder Bubble International School`,bodyClass:`terms-of-service-page`,mainHtml:Zn},{name:`404`,title:`404 · Kinder Bubble International School`,bodyClass:`page-404`,mainHtml:Qn},...Er];function Or(e,t){e()&&t()}var kr=/\.pdf(\?|#|$)/i,Ar=`__kbGalleryEffectsController__`,jr=`__kbNavOutsideClickController__`;function Mr(e=document){e.querySelectorAll(`a[href]`).forEach(e=>{let t=e.getAttribute(`href`)||``;kr.test(t)&&(e.setAttribute(`target`,`_blank`),e.setAttribute(`rel`,`noopener noreferrer`))})}function Nr(){document.body?.classList.remove(`kb-gallery-open`),document.documentElement?.classList.remove(`kb-gallery-open`)}function Pr(){let e=document.body,t=document.querySelector(`#header`);e.classList.remove(`mobile-nav-active`);let n=document.querySelector(`.scroll-top`),r=document.querySelector(`#preloader`),i=document.querySelector(`.mobile-nav-toggle`),a=()=>{t&&(!t.classList.contains(`scroll-up-sticky`)&&!t.classList.contains(`sticky-top`)&&!t.classList.contains(`fixed-top`)||(window.scrollY>100?e.classList.add(`scrolled`):e.classList.remove(`scrolled`)))},o=()=>{n&&(window.scrollY>100?n.classList.add(`active`):n.classList.remove(`active`))},s=()=>{if(!t)return;let e=Math.round(t.getBoundingClientRect().height);document.documentElement.style.setProperty(`--kb-header-stack`,`${e}px`)},c=e=>{e.target.closest(`.navmenu > ul`)||e.preventDefault()},l=e=>{e.target.closest(`.navmenu > ul`)||e.preventDefault()},u=()=>{document.addEventListener(`touchmove`,c,{passive:!1}),document.addEventListener(`wheel`,l,{passive:!1})},d=()=>{document.removeEventListener(`touchmove`,c),document.removeEventListener(`wheel`,l)},f=()=>{e.classList.contains(`mobile-nav-active`)&&(d(),e.classList.remove(`mobile-nav-active`),i&&(i.classList.add(`bi-list`),i.classList.remove(`bi-x`)))};if(Or(()=>window.AOS,()=>{window.AOS.init({duration:600,easing:`ease-in-out`,once:!0,mirror:!1})}),Or(()=>window.PureCounter,()=>{new window.PureCounter}),Or(()=>window.Swiper,()=>{document.querySelectorAll(`.init-swiper`).forEach(e=>{let t=e.querySelector(`.swiper-config`);if(!t)return;let n=JSON.parse(t.innerHTML.trim());new window.Swiper(e,n)})}),Or(()=>window.GLightbox,()=>{window.GLightbox({selector:`.glightbox`})}),i&&(i.onclick=()=>{let n=t?Math.round(t.getBoundingClientRect().bottom):64,r=Math.min(n+8,Math.max(72,window.innerHeight-220));document.documentElement.style.setProperty(`--kb-mobile-nav-top`,`${r}px`),e.classList.contains(`mobile-nav-active`)?d():u(),e.classList.toggle(`mobile-nav-active`),i&&(i.classList.toggle(`bi-list`),i.classList.toggle(`bi-x`))}),window[jr]&&window[jr].abort(),window[jr]=new AbortController,document.addEventListener(`click`,t=>{e.classList.contains(`mobile-nav-active`)&&(t.target.closest(`.navmenu > ul, .mobile-nav-toggle`)||f())},{signal:window[jr].signal}),document.querySelectorAll(`#navmenu a`).forEach(e=>{e.onclick=()=>{let t=e.getAttribute(`href`);!t||t===`#`||f()}}),document.querySelectorAll(`.navmenu .dropdown > a`).forEach(e=>{e.querySelector(`.toggle-dropdown`)&&(e.onclick=t=>{t.preventDefault(),t.stopImmediatePropagation();let n=e.classList.contains(`active`);(e.parentElement?.parentElement)?.querySelectorAll(`:scope > li.dropdown > a.active`).forEach(t=>{t!==e&&(t.classList.remove(`active`),t.nextElementSibling?.classList.remove(`dropdown-active`))}),e.classList.toggle(`active`,!n),e.nextElementSibling?.classList.toggle(`dropdown-active`,!n)})}),n&&(n.onclick=e=>{e.preventDefault(),window.scrollTo({top:0,behavior:`smooth`})}),r&&r.remove(),Mr(),document.querySelectorAll(`.feature-card, .program-item, .facility-card, .organization-card, .athletics-card, .faculty-card, .secondary-post, .tab-post, .event-item, .contact-card, .post-item, .metric-card, .activity-item, .kb-rich-card, .kb-profile-card, .kb-update-card, .kb-album-card`).forEach(e=>{if(e.hasAttribute(`data-href`))return;let t=e.querySelector(`a[href]`)?.getAttribute(`href`);t&&t!==`#`&&e.setAttribute(`data-href`,t)}),document.querySelectorAll(`[data-href]`).forEach(e=>{e.setAttribute(`tabindex`,e.getAttribute(`tabindex`)||`0`),e.setAttribute(`role`,e.getAttribute(`role`)||`link`);let t=()=>{let t=e.getAttribute(`data-href`);t&&(window.location.href=t)};e.onclick=e=>{e.target.closest(`a, button, input, select, textarea, label`)||t()},e.onkeydown=e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),t())}}),window.matchMedia(`(pointer: coarse)`).matches){let e=document.querySelectorAll(`.featured-activity`);if(e.length&&`IntersectionObserver`in window){let t=new IntersectionObserver(e=>{e.forEach(e=>{e.target.classList.toggle(`kb-overlay-visible`,e.isIntersecting)})},{threshold:.45});e.forEach(e=>t.observe(e))}}Nr(),window[Ar]&&window[Ar].abort(),window[Ar]=new AbortController;let p=window[Ar].signal;document.querySelectorAll(`body > .kb-gallery-viewer`).forEach(e=>e.remove()),document.querySelectorAll(`.kb-gallery-albums`).forEach(e=>{let t=e.parentElement?.querySelector(`.kb-gallery-viewer`);if(!t)return;document.body.appendChild(t);let n=t.querySelector(`.kb-gallery-viewer-panel`);n?.addEventListener(`click`,e=>e.stopPropagation(),{signal:p});let r=t.querySelector(`.kb-gallery-stage img`),i=t.querySelector(`.kb-gallery-caption h3`),a=t.querySelector(`.kb-gallery-caption p`),o=t.querySelector(`.kb-gallery-back`),s=t.querySelector(`.kb-gallery-prev`),c=t.querySelector(`.kb-gallery-next`),l=t.querySelector(`.kb-gallery-thumbrail`),u=t.querySelector(`.kb-gallery-toolbar strong`),d=t.querySelector(`.kb-gallery-toolbar span`);if(!r||!i||!a||!o||!s||!c||!l||!u||!d)return;let f=[],m=0,h=null,g=0,_=0,v=()=>{let e=f[m];return e?.src?(r.src=e.src,r.alt=e.title,i.textContent=e.title,a.textContent=e.caption,d.textContent=`${m+1} / ${f.length}`,l.querySelectorAll(`button`).forEach((e,t)=>{e.classList.toggle(`is-active`,t===m),e.setAttribute(`aria-current`,t===m?`true`:`false`)}),!0):!1},y=e=>{f.length&&(m=(e+f.length)%f.length,v())},b=()=>{t.classList.remove(`is-open`),t.setAttribute(`aria-hidden`,`true`),r.removeAttribute(`src`),l.replaceChildren(),f=[],Nr(),h&&h.focus()},x=e=>{if(f=Array.from(e.querySelectorAll(`[data-gallery-src]`)).map(e=>({src:e.dataset.gallerySrc||``,title:e.dataset.galleryTitle||``,caption:e.dataset.galleryCaption||``})).filter(e=>e.src),!f.length){b();return}if(m=0,h=e,u.textContent=e.querySelector(`.kb-gallery-album-copy strong`)?.textContent||`Gallery album`,u.id=`kb-gallery-dialog-title`,n?.setAttribute(`aria-labelledby`,`kb-gallery-dialog-title`),l.replaceChildren(...f.map((e,t)=>{let n=document.createElement(`button`);return n.type=`button`,n.setAttribute(`aria-label`,`Show photo ${t+1}: ${e.title}`),n.innerHTML=`<img src="${e.src}" alt="">`,n.onclick=()=>y(t),n})),!v()){b();return}t.classList.add(`is-open`),t.setAttribute(`aria-hidden`,`false`),document.body.classList.add(`kb-gallery-open`),document.documentElement.classList.add(`kb-gallery-open`),o.focus()};e.querySelectorAll(`.kb-gallery-album`).forEach(e=>{e.onclick=()=>x(e)}),o.onclick=b,s.onclick=()=>y(m-1),c.onclick=()=>y(m+1),t.onclick=e=>{e.target===t&&b()},t.ontouchstart=e=>{let t=e.changedTouches[0];g=t.clientX,_=t.clientY},t.ontouchend=e=>{let t=e.changedTouches[0],n=t.clientX-g,r=t.clientY-_;Math.abs(n)<48||Math.abs(n)<Math.abs(r)*1.25||y(m+(n<0?1:-1))},document.addEventListener(`keydown`,e=>{t.classList.contains(`is-open`)&&(e.key===`Escape`&&b(),e.key===`ArrowLeft`&&y(m-1),e.key===`ArrowRight`&&y(m+1))},{signal:p})}),a(),o(),s(),window.addEventListener(`scroll`,a),window.addEventListener(`scroll`,o),window.addEventListener(`resize`,()=>{s();let e=t?Math.round(t.getBoundingClientRect().bottom):64,n=Math.min(e+8,Math.max(72,window.innerHeight-220));document.documentElement.style.setProperty(`--kb-mobile-nav-top`,`${n}px`)}),document.fonts?.ready&&document.fonts.ready.then(s).catch(()=>{})}function Fr(){document.querySelectorAll(`.php-email-form`).forEach(e=>{e.onsubmit=async t=>{t.preventDefault();let n=e.querySelector(`.loading`),r=e.querySelector(`.error-message`),i=e.querySelector(`.sent-message`);n&&(n.style.display=`block`),r&&(r.style.display=`none`,r.textContent=``),i&&(i.style.display=`none`);let a=new FormData(e),[o,...s]=(a.get(`name`)||``).toString().trim().split(/\s+/).filter(Boolean),c={firstName:o||`Website`,lastName:s.join(` `)||`Visitor`,email:(a.get(`email`)||``).toString().trim(),phone:(a.get(`phone`)||``).toString().trim(),program:(a.get(`subject`)||``).toString().trim(),message:(a.get(`message`)||a.get(`subject`)||`Website enquiry`).toString().trim(),source:e.dataset.formType||document.body.className||`website`,pagePath:window.location.pathname};try{let t=await fetch(`/api/contact`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(c)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(n.message||`Form submission failed.`);e.reset(),i&&(i.style.display=`block`)}catch(e){r&&(r.textContent=e.message||`Unable to send your message.`,r.style.display=`block`)}finally{n&&(n.style.display=`none`)}}})}var Ir=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),N=o(((e,t)=>{t.exports=Ir()}))(),Lr=14,Rr=18,zr=6,Br=8;function Vr(e){return e===`index`||/student-life|students-life|news|event|gallery/i.test(e)?`playful`:/admission|parents|academics|privacy|terms|policies/i.test(e)?`abstract`:`neutral`}function Hr({variant:e=`playful`,mode:t=`page`}){let n=t===`hero`?Rr:Lr,r=t===`hero`?Br:zr,i=(0,x.useMemo)(()=>Array.from({length:n},(e,t)=>t),[n]),a=(0,x.useMemo)(()=>Array.from({length:r},(e,t)=>t),[r]);return(0,N.jsxs)(`div`,{className:`kb-ambient kb-ambient--${e} kb-ambient--${t}`,"aria-hidden":`true`,children:[i.map(e=>(0,N.jsx)(`span`,{className:`kb-ambient-bubble kb-ambient-bubble--${e%12+1}`},`b${e}`)),a.map(e=>(0,N.jsx)(`span`,{className:`kb-ambient-shape kb-ambient-shape--${e%6+1}`},`s${e}`))]})}var Ur=[{id:`play`,prefix:`Where young minds `,highlight:`bubble`,suffix:` with curiosity, & play with purpose.`,blurb:`Structured and free play in bright, safe spaces — because joyful children learn best when they feel at home.`,imageSrc:`/assets/images/extra-curricular/children-playing-with-ball.jpeg`,imageAlt:`Children learning and playing at KBIS`,badge:`Play with purpose`},{id:`learn`,prefix:``,highlight:`Cambridge-inspired`,suffix:` learning in English and French everyday.`,blurb:A.curriculum+`, with room for creativity, movement, and everyday discovery.`,imageSrc:`/assets/images/learning/students-smiling-at-computers.jpeg`,imageAlt:`Classrooms and discovery at KBIS`,badge:`Bilingual exposure`},{id:`ages`,prefix:`Nurturing every stage from `,highlight:`six months to ten years`,suffix:` here in Accra.`,blurb:`From creche through primary, one caring team walks with your child as they grow in confidence and character.`,imageSrc:`/assets/images/students/smiling-boy-in-class-hero.jpeg`,imageAlt:`Primary learners building confidence at KBIS`,badge:`One campus family`},{id:`confidence`,prefix:`Small classes where every child is `,highlight:`seen`,suffix:`, supported, and known.`,blurb:`Teachers know children by name, notice their next step, and build confidence through steady routines.`,imageSrc:`/assets/images/students/three-children-smiling-uniforms.jpeg`,imageAlt:`Three KBIS learners smiling in uniform`,badge:`Known by name`},{id:`technology`,prefix:`Hands-on discovery from books, `,highlight:`technology`,suffix:`, and daily projects.`,blurb:`Learning studios include practical materials, computer time, music, and age-right inquiry work.`,imageSrc:`/assets/images/learning/boy-at-computer-lab.jpeg`,imageAlt:`KBIS learner using a computer`,badge:`Modern learning`},{id:`languages`,prefix:`English and French help children grow as `,highlight:`global`,suffix:` communicators.`,blurb:`Bilingual exposure is woven through stories, songs, classroom phrases, and daily conversation.`,imageSrc:`/assets/images/learning/teacher-guided-table-activity.jpeg`,imageAlt:`Teacher guiding a group learning activity`,badge:`English + French`},{id:`care`,prefix:`Daily care routines help every family feel `,highlight:`secure`,suffix:` every day.`,blurb:`Health, safety, authorised pick-up, and clear family communication are part of the school day.`,imageSrc:`/assets/images/students/children-seated-blue-classroom.jpeg`,imageAlt:`Children seated safely in a classroom`,badge:`Safety first`},{id:`arts`,prefix:`Creative moments help every learner find their `,highlight:`voice`,suffix:` with joy.`,blurb:`Music, role play, presentation, and celebration build expression without putting pressure on children.`,imageSrc:`/assets/images/extra-curricular/career-day-children-in-costumes.jpeg`,imageAlt:`Children dressed for career day`,badge:`Creative confidence`},{id:`trips`,prefix:`Educational trips turn curiosity into `,highlight:`experience`,suffix:` beyond campus.`,blurb:`Themed excursions help children connect classroom ideas with the wider world around them.`,imageSrc:`/assets/images/extra-curricular/students-with-ghana-flags-at-monument.jpeg`,imageAlt:`KBIS learners on an educational trip`,badge:`Learning journeys`},{id:`community`,prefix:`A school community built around `,highlight:`one family`,suffix:` at a time with care.`,blurb:`Parents, teachers, and leadership work together so each child has a steady circle of support.`,imageSrc:`/assets/images/extra-curricular/parents-and-children-at-event.jpeg`,imageAlt:`Parents and children together at a school event`,badge:`Family partnership`}],Wr=76,Gr=3100,Kr=[`fade`,`zoom`,`slide-left`,`slide-up`],qr=1.18,Jr=3,Yr=11,Xr=44,Zr=9,Qr=14;function $r(e){return e.prefix.length+e.highlight.length+e.suffix.length}function ei(e){return`${e.prefix}${e.highlight}${e.suffix}`}function ti(e,t){let{prefix:n,highlight:r,suffix:i}=t,a=n.length,o=a+r.length;return e<=a?{p:n.slice(0,e),h:``,s:``}:e<=o?{p:n,h:r.slice(0,e-a),s:``}:{p:n,h:r,s:i.slice(0,e-o)}}function ni(e,t,n,r,i,a,o=Yr,s=Xr){let c=getComputedStyle(t);e.style.boxSizing=`border-box`,e.style.width=`${r}px`,e.style.fontFamily=c.fontFamily,e.style.fontWeight=c.fontWeight,e.style.fontStyle=c.fontStyle,e.style.letterSpacing=c.letterSpacing,e.style.textTransform=c.textTransform,e.style.lineHeight=String(a),e.style.wordBreak=`break-word`,e.style.overflowWrap=`anywhere`,e.style.whiteSpace=i===1?`nowrap`:`normal`,e.textContent=n;let l=t=>{e.style.fontSize=`${t}px`;let n=getComputedStyle(e).lineHeight,o=parseFloat(n);(Number.isNaN(o)||n===`normal`)&&(o=t*a);let s=e.scrollHeight<=o*i+1.5,c=i>1||e.scrollWidth<=r+1.5;return s&&c};if(!l(o))return o;if(l(s))return s;let u=o,d=s;for(let e=0;e<30;e++){let e=(u+d)/2;l(e)?u=e:d=e}return u}function ri(e,t,n){(0,x.useLayoutEffect)(()=>{let r=e.current,i=t.current;if(!r||!i)return;let a=!1,o=()=>{if(a)return;let e=getComputedStyle(r),t=(parseFloat(e.paddingLeft)||0)+(parseFloat(e.paddingRight)||0),o=Math.max(0,r.clientWidth-t);if(o<32)return;let s=ni(i,r,n,o,1,1.2,Zr,Qr);r.style.setProperty(`--kb-hero-eyebrow-fs`,`${s}px`)},s=()=>requestAnimationFrame(()=>!a&&o());s();let c=typeof document<`u`&&document.fonts?.ready?document.fonts.ready:null;c&&typeof c.then==`function`&&c.then(()=>!a&&s());let l=new ResizeObserver(()=>s());return l.observe(r),window.addEventListener(`resize`,s),()=>{a=!0,l.disconnect(),window.removeEventListener(`resize`,s)}},[n])}function ii(e,t){(0,x.useLayoutEffect)(()=>{let n=e.current,r=t.current;if(!n||!r)return;let i=!1,a=()=>{if(i)return;let e=getComputedStyle(n),t=(parseFloat(e.paddingLeft)||0)+(parseFloat(e.paddingRight)||0),a=Math.max(0,n.clientWidth-t);if(a<48)return;let o=Ur.map(e=>ei(e)),s=Xr;for(let e of o)s=Math.min(s,ni(r,n,e,a,Jr,qr));n.style.setProperty(`--kb-hero-title-fs`,`${s}px`),n.style.lineHeight=String(qr)},o=()=>{requestAnimationFrame(()=>{i||a()})};o();let s=typeof document<`u`&&document.fonts?.ready?document.fonts.ready:null;s&&typeof s.then==`function`&&s.then(()=>{i||o()});let c=new ResizeObserver(()=>o());return c.observe(n),window.addEventListener(`resize`,o),()=>{i=!0,c.disconnect(),window.removeEventListener(`resize`,o)}},[])}function ai(){let e=(0,x.useRef)(null),t=(0,x.useRef)(null),n=(0,x.useRef)(null),r=(0,x.useRef)(null),i=`${A.legalName} (KBIS)`,[a,o]=(0,x.useState)(0),[s,c]=(0,x.useState)(0),[l,u]=(0,x.useState)(Kr[0]);ii(e,t),ri(n,r,i);let d=Ur[a],f=$r(d),{p,h:m,s:h}=(0,x.useMemo)(()=>ti(s,d),[s,a]);(0,x.useEffect)(()=>{window.AOS&&(typeof window.AOS.refreshHard==`function`?window.AOS.refreshHard():window.AOS.refresh())},[a]),(0,x.useEffect)(()=>{let e=Ur[a],t=$r(e);if(typeof window<`u`&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches){c(t);let e=window.setTimeout(()=>{o(e=>(e+1)%Ur.length)},6500);return()=>window.clearTimeout(e)}c(0);let n=0,r=!1,i,s=()=>{r||(n+=1,n<=t?(c(n),i=window.setTimeout(s,Wr)):i=window.setTimeout(()=>{r||ee((a+1)%Ur.length)},Gr))};return i=window.setTimeout(s,Wr),()=>{r=!0,window.clearTimeout(i)}},[a]);let g=(0,x.useMemo)(()=>Ur.map((e,t)=>(0,N.jsx)(`button`,{type:`button`,className:`kb-hero-dot${t===a?` is-active`:``}`,"aria-label":`Show slide ${t+1}`,"aria-current":t===a?`true`:void 0,onClick:()=>ee(t)},e.id)),[a]),_=ei(d),v=typeof window<`u`&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,y=!v&&s<f,b=e=>{let t=Kr.filter(t=>t!==e);return t[Math.floor(Math.random()*t.length)]||Kr[0]},ee=e=>{v||u(e=>b(e)),o(e)},S=(0,N.jsxs)(`div`,{className:`kb-hero-media-frame kb-hero-img-stack kb-transition-${l}`,children:[Ur.map((e,t)=>(0,N.jsx)(`img`,{src:e.imageSrc,alt:e.imageAlt,className:`img-fluid main-image kb-hero-stack-img${t===a?` is-active`:``}`,width:900,height:720,loading:t===0?`eager`:`lazy`,decoding:`async`},e.id)),(0,N.jsx)(`div`,{className:`kb-hero-badge-wrap`,"aria-live":`polite`,children:(0,N.jsxs)(`div`,{className:`badge-accredited`,children:[(0,N.jsx)(`i`,{className:`bi ${j.accredited}`,"aria-hidden":`true`}),(0,N.jsx)(`span`,{children:d.badge},d.badge)]})})]});return(0,N.jsxs)(`section`,{id:`hero`,className:`hero section kb-hero`,children:[(0,N.jsx)(Hr,{variant:`hero`,mode:`hero`}),(0,N.jsx)(`div`,{className:`hero-wrapper`,children:(0,N.jsx)(`div`,{className:`container`,children:(0,N.jsxs)(`div`,{className:`row align-items-center`,children:[(0,N.jsxs)(`div`,{className:`col-lg-6 hero-content position-relative`,"data-aos":`fade-right`,"data-aos-delay":`100`,children:[(0,N.jsx)(`p`,{ref:n,className:`kb-hero-schoolname`,children:i}),(0,N.jsx)(`span`,{ref:r,className:`kb-hero-eyebrow-measure`,"aria-hidden":`true`}),(0,N.jsx)(`div`,{ref:t,className:`kb-hero-title-measure`,"aria-hidden":`true`}),(0,N.jsxs)(`h1`,{ref:e,className:`kb-hero-title`,"aria-label":_,children:[(0,N.jsx)(`span`,{className:`kb-hero-title-static`,children:p}),(0,N.jsx)(`span`,{className:`kb-hero-title-swap`,children:m},d.id),(0,N.jsx)(`span`,{className:`kb-hero-title-static`,children:h}),y?(0,N.jsx)(`span`,{className:`kb-hero-caret`,"aria-hidden":`true`}):null]}),(0,N.jsx)(`div`,{className:`hero-media d-lg-none`,"data-aos":`zoom-in`,"data-aos-delay":`200`,children:S}),(0,N.jsx)(`p`,{className:`kb-hero-lead`,children:d.blurb},d.id),(0,N.jsxs)(`div`,{className:`action-buttons`,children:[(0,N.jsx)(k,{to:`/admissions`,className:`btn-primary`,children:`Plan a visit`}),(0,N.jsx)(k,{to:`/contact`,className:`btn-secondary`,children:`Talk to admissions`})]}),(0,N.jsx)(`div`,{className:`kb-hero-dots`,role:`tablist`,"aria-label":`Hero highlights`,children:g})]}),(0,N.jsx)(`div`,{className:`col-lg-6 hero-media d-none d-lg-block`,"data-aos":`zoom-in`,"data-aos-delay":`200`,children:S})]})})}),(0,N.jsx)(`div`,{className:`feature-cards-wrapper`,"data-aos":`fade-up`,"data-aos-delay":`300`,children:(0,N.jsx)(`div`,{className:`container`,children:(0,N.jsxs)(`div`,{className:`row gy-4`,children:[(0,N.jsx)(`div`,{className:`col-lg-4`,"data-aos":`fade-up`,"data-aos-delay":`100`,children:(0,N.jsxs)(k,{to:`/academics/programmes`,className:`feature-card d-flex text-decoration-none`,children:[(0,N.jsx)(`div`,{className:`feature-icon`,children:(0,N.jsx)(`i`,{className:`bi ${j.programsByAge}`,"aria-hidden":`true`})}),(0,N.jsxs)(`div`,{className:`feature-content`,children:[(0,N.jsx)(`h3`,{children:`Programs by age`}),(0,N.jsxs)(`p`,{children:[(0,N.jsx)(`strong`,{children:A.ages}),` — creche, nursery, kindergarten, reception, and primary.`]})]})]})}),(0,N.jsx)(`div`,{className:`col-lg-4`,"data-aos":`fade-up`,"data-aos-delay":`200`,children:(0,N.jsxs)(k,{to:`/student-life/extra-curricular`,className:`feature-card d-flex text-decoration-none`,children:[(0,N.jsx)(`div`,{className:`feature-icon`,children:(0,N.jsx)(`i`,{className:`bi ${j.indoorOutdoorPlay}`,"aria-hidden":`true`})}),(0,N.jsxs)(`div`,{className:`feature-content`,children:[(0,N.jsx)(`h3`,{children:`Indoor & outdoor play`}),(0,N.jsxs)(`p`,{children:[A.highlights[0],` — ideal for growing bodies and imaginations.`]})]})]})}),(0,N.jsx)(`div`,{className:`col-lg-4`,"data-aos":`fade-up`,"data-aos-delay":`300`,children:(0,N.jsxs)(k,{to:`/resources/policies`,className:`feature-card d-flex text-decoration-none`,children:[(0,N.jsx)(`div`,{className:`feature-icon`,children:(0,N.jsx)(`i`,{className:`bi ${j.safety}`,"aria-hidden":`true`})}),(0,N.jsxs)(`div`,{className:`feature-content`,children:[(0,N.jsx)(`h3`,{children:`Safety first`}),(0,N.jsxs)(`p`,{children:[A.highlights[2],` so families can focus on learning milestones.`]})]})]})})]})})}),(0,N.jsx)(`div`,{className:`upcoming-event`,"data-aos":`fade-up`,"data-aos-delay":`400`,children:(0,N.jsx)(`div`,{className:`container`,children:(0,N.jsxs)(`div`,{className:`event-content`,children:[(0,N.jsxs)(`div`,{className:`event-date`,children:[(0,N.jsx)(`span`,{className:`day`,children:`●`}),(0,N.jsx)(`span`,{className:`month`,children:`NOW`})]}),(0,N.jsxs)(`div`,{className:`event-info`,children:[(0,N.jsx)(`h3`,{children:`Rolling admissions`}),(0,N.jsxs)(`p`,{children:[A.highlights[1],`. Reach us at`,` `,(0,N.jsx)(`a`,{href:`tel:${A.phoneTel}`,children:A.phoneDisplay}),` — we would love to meet your family.`]})]}),(0,N.jsxs)(`div`,{className:`event-action`,children:[(0,N.jsx)(k,{to:`/admissions`,className:`btn-event`,children:`Admissions`}),(0,N.jsx)(`span`,{className:`countdown`,children:A.hours})]})]})})})]})}var oi=[{label:`Home`,path:`/`},{label:`About`,children:[{label:`About Us`,path:`/about`},{label:`Mission & Vision`,path:`/about/mission-vision`},{label:`Board of Directors`,path:`/about/board-of-directors`},{label:`Management`,path:`/about/management`},{label:`Principal`,path:`/about/principal`},{label:`Staff`,children:[{label:`Teaching Staff`,path:`/about/staff/teaching`},{label:`Support Staff`,path:`/about/staff/support`}]}]},{label:`Academics`,children:[{label:`Admission`,path:`/admissions`},{label:`Curriculum`,path:`/academics/curriculum`},{label:`Programmes`,path:`/academics/programmes`},{label:`Languages`,path:`/academics/languages`},{label:`Academic Calendar`,path:`/academics/academic-calendar`}]},{label:`Student Life`,children:[{label:`SRC`,path:`/student-life/src`},{label:`Houses`,path:`/student-life/houses`},{label:`Extra-Curricular`,path:`/student-life/extra-curricular`}]},{label:`Parents`,children:[{label:`Admission Form`,path:`/parents/admission-form`},{label:`Plan a Visit`,path:`/parents/plan-a-visit`},{label:`Make Payment`,path:`/parents/make-payment`},{label:`Student Handbook`,path:`/parents/student-handbook`}]},{label:`Resources`,children:[{label:`Gallery`,path:`/resources/gallery`},{label:`Policies`,path:`/resources/policies`}]},{label:`News`,children:[{label:`News`,path:`/news`},{label:`Events`,path:`/events`},{label:`Partnerships`,path:`/news/partnerships`}]}];function si({item:e}){return e.children?.length?(0,N.jsxs)(`li`,{className:`dropdown`,children:[(0,N.jsxs)(`a`,{href:`#`,children:[(0,N.jsx)(`span`,{children:e.label}),` `,(0,N.jsx)(`i`,{className:`bi bi-chevron-down toggle-dropdown`,"aria-hidden":`true`})]}),(0,N.jsx)(`ul`,{children:e.children.map(e=>(0,N.jsx)(si,{item:e},e.path||e.label))})]}):(0,N.jsx)(`li`,{children:(0,N.jsx)(k,{to:e.path,end:!0,children:e.label})})}function ci({item:e}){return e.path?(0,N.jsx)(`li`,{children:(0,N.jsx)(k,{to:e.path,end:e.path===`/`,children:e.label})}):(0,N.jsxs)(`li`,{className:`dropdown`,children:[(0,N.jsxs)(`a`,{href:`#`,children:[(0,N.jsx)(`span`,{children:e.label}),` `,(0,N.jsx)(`i`,{className:`bi bi-chevron-down toggle-dropdown`,"aria-hidden":`true`})]}),(0,N.jsx)(`ul`,{children:e.children.map(e=>(0,N.jsx)(si,{item:e},e.path||e.label))})]})}function li(){return(0,N.jsxs)(`nav`,{id:`navmenu`,className:`navmenu`,children:[(0,N.jsxs)(`ul`,{children:[oi.map(e=>(0,N.jsx)(ci,{item:e},e.path||e.label)),(0,N.jsx)(`li`,{className:`kb-nav-cta`,children:(0,N.jsxs)(k,{to:`/contact`,children:[(0,N.jsx)(`i`,{className:`bi bi-envelope-paper-heart`,"aria-hidden":`true`}),` Enquire`]})})]}),(0,N.jsx)(k,{to:`/contact`,className:`kb-header-enquire-icon d-xl-none`,"aria-label":`Enquire`,title:`Enquire`,children:(0,N.jsx)(`i`,{className:`bi bi-envelope-paper-heart`,"aria-hidden":`true`})}),(0,N.jsx)(`i`,{className:`mobile-nav-toggle d-xl-none bi bi-list`,"aria-hidden":`true`})]})}var ui=[{path:`/`,key:`index`,label:`Home`},{path:`/about`,key:`about`,label:`About us`},{path:`/academics`,key:`academics`,label:`Academics`},{path:`/admissions`,key:`admissions`,label:`Admission`},{path:`/faculty-staff`,key:`faculty-staff`,label:`Our team`},{path:`/campus-facilities`,key:`campus-facilities`,label:`Campus & facilities`},{path:`/students-life`,key:`students-life`,label:`Student life`},{path:`/news`,key:`news`,label:`News`},{path:`/events`,key:`events`,label:`Events`},{path:`/contact`,key:`contact`,label:`Contact`},{path:`/news-details`,key:`news-details`,label:`News details`},{path:`/event-details`,key:`event-details`,label:`Event details`},{path:`/privacy`,key:`privacy`,label:`Privacy`},{path:`/terms-of-service`,key:`terms-of-service`,label:`Terms of service`},{path:`/404`,key:`404`,label:`404`},...Tr],di=Object.fromEntries(Dr.map(e=>[e.name,e]));function fi(e){return e.replace(/\s*<!-- Hero Section -->[\s\S]*?<!-- \/Hero Section -->\s*/,`
`)}function pi({pageKey:e}){let t=di[e]||di[404],n=(0,x.useMemo)(()=>{let n=t?.mainHtml||``;return e===`index`&&(n=fi(n)),n},[t,e]);return(0,x.useEffect)(()=>{let e=t?.bodyClass||`index-page`;document.body.className=e,document.title=t?.title||`KinderBubble International School`},[t]),(0,N.jsxs)(`main`,{className:`main`,children:[e===`index`?(0,N.jsx)(ai,{}):null,(0,N.jsxs)(`div`,{className:`kb-page-canvas`,children:[(0,N.jsx)(Hr,{variant:Vr(e),mode:`page`}),(0,N.jsx)(`div`,{className:`kb-page-canvas-inner`,dangerouslySetInnerHTML:{__html:n}})]})]})}var mi=[{path:`/about`,label:`About Us`},{path:`/admissions`,label:`Admissions`},{path:`/academics/programmes`,label:`Programmes`},{path:`/resources/gallery`,label:`Gallery`},{path:`/contact`,label:`Contact Us`}],hi=[{title:`Open enrolment for 2025–26 academic year`,path:`/admissions`,image:`/assets/images/students/formal-uniform-students-kbis-01.jpeg`},{title:`Global School Alliance partnership`,path:`/news/partnerships`,image:`/assets/images/others/global-school-alliance-certificate.png`},{title:`Educational trips by term theme`,path:`/events`,image:`/assets/images/extra-curricular/students-with-ghana-flags-at-monument.jpeg`}];function gi({children:e}){let t=new Date().getFullYear();return(0,N.jsxs)(N.Fragment,{children:[(0,N.jsx)(`header`,{id:`header`,className:`header kb-header d-flex align-items-center sticky-top`,children:(0,N.jsxs)(`div`,{className:`header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-end`,children:[(0,N.jsxs)(k,{to:`/`,className:`logo kb-header-logo d-flex align-items-center me-auto`,children:[(0,N.jsx)(`img`,{src:A.logoSrc,alt:`Kinder Bubble International School`,className:`kb-logo-img`,width:180,height:180}),(0,N.jsxs)(`span`,{className:`kb-logo-text ms-2 d-inline-flex flex-column`,children:[(0,N.jsx)(`span`,{className:`sitename`,children:A.shortName}),(0,N.jsx)(`small`,{children:`International School`})]})]}),(0,N.jsx)(li,{})]})}),e,(0,N.jsxs)(`footer`,{id:`footer`,className:`footer kb-footer light-background position-relative`,children:[(0,N.jsx)(`div`,{className:`kb-footer-glow`,"aria-hidden":`true`}),(0,N.jsx)(`div`,{className:`container footer-top kb-footer-top`,children:(0,N.jsxs)(`div`,{className:`kb-footer-top-row`,children:[(0,N.jsxs)(`section`,{className:`kb-footer-brand`,"aria-label":`School summary`,children:[(0,N.jsxs)(k,{to:`/`,className:`kb-footer-brand-lockup d-inline-flex align-items-center text-decoration-none`,children:[(0,N.jsx)(`img`,{src:A.logoSrc,alt:``,className:`kb-footer-logo-img`,width:120,height:120}),(0,N.jsxs)(`span`,{className:`kb-footer-wordmark ms-2 d-flex flex-column text-start`,children:[(0,N.jsx)(`span`,{className:`kb-footer-name`,children:A.shortName}),(0,N.jsx)(`span`,{className:`kb-footer-tag`,children:A.tagline})]})]}),(0,N.jsx)(`p`,{className:`kb-footer-brand-tagline`,children:`KBIS nurtures children from creche through primary with character, confidence, and bilingual learning.`}),(0,N.jsxs)(`div`,{className:`kb-footer-social`,"aria-label":`School contact shortcuts`,children:[(0,N.jsx)(`a`,{href:`tel:${A.phoneTel}`,"aria-label":`Call KBIS`,children:(0,N.jsx)(`i`,{className:`bi bi-telephone-fill`,"aria-hidden":`true`})}),(0,N.jsx)(`a`,{href:`mailto:${A.officeEmail}`,"aria-label":`Email KBIS`,children:(0,N.jsx)(`i`,{className:`bi bi-envelope-fill`,"aria-hidden":`true`})}),(0,N.jsx)(k,{to:`/contact`,"aria-label":`Visit contact page`,children:(0,N.jsx)(`i`,{className:`bi bi-geo-alt-fill`,"aria-hidden":`true`})})]})]}),(0,N.jsxs)(`section`,{className:`kb-footer-contact-col`,"aria-label":`Contacts`,children:[(0,N.jsx)(`h4`,{className:`kb-footer-heading`,children:`Contacts`}),(0,N.jsxs)(`ul`,{className:`kb-footer-contact list-unstyled`,children:[(0,N.jsxs)(`li`,{children:[(0,N.jsx)(`i`,{className:`bi bi-geo-alt-fill`,"aria-hidden":`true`}),(0,N.jsxs)(`span`,{children:[(0,N.jsx)(`span`,{className:`kb-footer-contact-label`,children:`Address`}),`Accra, Ghana`]})]}),(0,N.jsxs)(`li`,{children:[(0,N.jsx)(`i`,{className:`bi bi-send-fill`,"aria-hidden":`true`}),(0,N.jsxs)(`span`,{children:[(0,N.jsx)(`span`,{className:`kb-footer-contact-label`,children:`Email`}),(0,N.jsx)(`a`,{href:`mailto:${A.officeEmail}`,className:`kb-footer-link`,children:A.officeEmail})]})]}),(0,N.jsxs)(`li`,{children:[(0,N.jsx)(`i`,{className:`bi bi-telephone-fill`,"aria-hidden":`true`}),(0,N.jsxs)(`span`,{children:[(0,N.jsx)(`span`,{className:`kb-footer-contact-label`,children:`Phone`}),(0,N.jsx)(`a`,{href:`tel:${A.phoneTel}`,className:`kb-footer-link`,children:A.phoneDisplay})]})]})]})]}),(0,N.jsxs)(`section`,{className:`kb-footer-quick-col`,"aria-label":`Quick links`,children:[(0,N.jsx)(`h4`,{className:`kb-footer-heading`,children:`Quick Links`}),(0,N.jsx)(`ul`,{className:`kb-footer-nav-stack list-unstyled`,children:mi.map(e=>(0,N.jsx)(`li`,{children:(0,N.jsx)(k,{to:e.path,className:`kb-footer-nav-link`,children:e.label})},e.path))})]}),(0,N.jsxs)(`section`,{className:`kb-footer-news-col`,"aria-label":`Latest news`,children:[(0,N.jsx)(`h4`,{className:`kb-footer-heading`,children:`Latest News`}),(0,N.jsx)(`div`,{className:`kb-footer-news-list`,children:hi.map(e=>(0,N.jsxs)(k,{to:e.path,className:`kb-footer-news-item`,children:[(0,N.jsx)(`img`,{src:e.image,alt:``,loading:`lazy`}),(0,N.jsx)(`span`,{children:e.title})]},e.title))})]})]})}),(0,N.jsx)(`div`,{className:`kb-footer-bottom`,children:(0,N.jsxs)(`div`,{className:`container py-3 d-flex flex-column flex-md-row flex-wrap align-items-center justify-content-md-between gap-2 kb-footer-bottom-inner`,children:[(0,N.jsxs)(`p`,{className:`mb-0 small kb-footer-copy`,children:[`© `,t,` `,A.legalName,`. All rights reserved.`]}),(0,N.jsxs)(`nav`,{className:`d-flex flex-wrap gap-3 small kb-footer-legal-nav`,"aria-label":`Legal`,children:[(0,N.jsx)(k,{to:`/privacy`,className:`kb-footer-legal-link`,children:`Privacy`}),(0,N.jsx)(k,{to:`/terms-of-service`,className:`kb-footer-legal-link`,children:`Terms of service`})]})]})})]}),(0,N.jsx)(`a`,{href:`#`,id:`scroll-top`,className:`scroll-top d-flex align-items-center justify-content-center`,children:(0,N.jsx)(`i`,{className:`bi bi-arrow-up-short`})}),(0,N.jsx)(`div`,{id:`preloader`})]})}function _i(){let e=lt();return(0,x.useEffect)(()=>{window.scrollTo({top:0,left:0,behavior:`auto`})},[e.pathname]),(0,x.useEffect)(()=>{Pr(),Fr()},[e.pathname]),(0,N.jsx)(gi,{children:(0,N.jsxs)(zt,{children:[ui.map(e=>(0,N.jsx)(Lt,{path:e.path,element:(0,N.jsx)(pi,{pageKey:e.key})},e.path)),(0,N.jsx)(Lt,{path:`*`,element:(0,N.jsx)(pi,{pageKey:`404`})})]})})}(0,qn.createRoot)(document.getElementById(`root`)).render((0,N.jsx)(x.StrictMode,{children:(0,N.jsx)(Dn,{children:(0,N.jsx)(_i,{})})}));